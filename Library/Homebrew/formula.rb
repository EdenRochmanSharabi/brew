...
class Formula
  ...
  sig { returns(T::Boolean) }
  def post_install_steps_defined? = post_install_steps.present?
  ...
  class << self
    ...
    #
    # @api public
    sig { params(steps: T::Array[T.untyped], block: T.nilable(T.proc.void)).returns(Homebrew::InstallSteps::Steps) }
